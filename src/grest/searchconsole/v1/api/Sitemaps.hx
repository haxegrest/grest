...
interface Sitemaps {
	...
	**/
	...
	function get(siteUrl:String, feedpath:String):grest.searchconsole.v1.types.WmxSitemap;
	/**
	...
	**/
	@:optional
	var sitemapIndex : String; }):grest.searchconsole.v1.types.SitemapsListResponse;
	/**
