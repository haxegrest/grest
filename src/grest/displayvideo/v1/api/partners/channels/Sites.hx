package grest.displayvideo.v1.api.partners.channels;
interface Sites {
	/**
		Bulk edits sites under a single channel. The operation will delete the sites provided in BulkEditSitesRequest.deleted_sites and then create the sites provided in BulkEditSitesRequest.created_sites.
	**/
	@:post("/v1/partners/$partnerId/channels/$channelId/sites:bulkEdit")
	function bulkEdit(partnerId:String, channelId:String, body:grest.displayvideo.v1.types.BulkEditSitesRequest):grest.displayvideo.v1.types.BulkEditSitesResponse;
	/**
		Creates a site in a channel.
	**/
	@:post("/v1/partners/$partnerId/channels/$channelId/sites")
	function create(partnerId:String, channelId:String, query:{ /**
		The ID of the advertiser that owns the parent channel.
	**/
	@:optional
	var advertiserId : String; }, body:grest.displayvideo.v1.types.Site):grest.displayvideo.v1.types.Site;
	/**
		Deletes a site from a channel.
	**/
	@:delete("/v1/partners/$partnerId/channels/$channelId/sites/$urlOrAppId")
	function delete(partnerId:String, channelId:String, urlOrAppId:String, query:{ /**
		The ID of the advertiser that owns the parent channel.
	**/
	@:optional
	var advertiserId : String; }):grest.displayvideo.v1.types.Empty;
	/**
		Lists sites in a channel.
	**/
	@:get("/v1/partners/$partnerId/channels/$channelId/sites")
	function list(partnerId:String, channelId:String, query:{ /**
		The ID of the advertiser that owns the parent channel.
	**/
	@:optional
	...
	**/
	@:optional
	var pageToken : String; }):grest.displayvideo.v1.types.ListSitesResponse;
	/**
	...
	**/
	@:post("/v1/partners/$partnerId/channels/$channelId/sites:replace")
	function replace(partnerId:String, channelId:String, body:grest.displayvideo.v1.types.ReplaceSitesRequest):grest.displayvideo.v1.types.ReplaceSitesResponse;
}