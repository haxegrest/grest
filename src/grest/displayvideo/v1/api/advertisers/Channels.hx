...
interface Channels {
	...
	**/
	@:post("/v1/advertisers/$advertiserId/channels")
	function create(advertiserId:String, query:{ /**
		The ID of the partner that owns the created channel.
	**/
	@:optional
	var partnerId : String; }, body:grest.displayvideo.v1.types.Channel):grest.displayvideo.v1.types.Channel;
	/**
		Gets a channel for a partner or advertiser.
	**/
	@:get("/v1/advertisers/$advertiserId/channels/$channelId")
	function get(advertiserId:String, channelId:String, query:{ /**
		The ID of the partner that owns the fetched channel.
	**/
	@:optional
	var partnerId : String; }):grest.displayvideo.v1.types.Channel;
	/**
		Lists channels for a partner or advertiser.
	**/
	@:get("/v1/advertisers/$advertiserId/channels")
	...
	**/
	@:optional
	var partnerId : String; }):grest.displayvideo.v1.types.ListChannelsResponse;
	/**
		Updates a channel. Returns the updated channel if successful.
	**/
	@:patch("/v1/advertisers/$advertiserId/channels/$channelId")
	function patch(advertiserId:String, channelId:String, query:{ /**
		The ID of the partner that owns the created channel.
	**/
	@:optional
	...
	**/
	...
	@:sub("/")
	var sites : grest.displayvideo.v1.api.advertisers.channels.Sites;
}