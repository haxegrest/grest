package grest.securitycenter.v1.api.projects.sources;
interface Findings {
	/**
	...
	**/
	@:post("/v1/$name")
	function setState(name:grest.securitycenter.v1.types.Api_securitycenter_projects_sources_findings_setState_name_Command, body:grest.securitycenter.v1.types.SetFindingStateRequest):grest.securitycenter.v1.types.Finding;
	/**
