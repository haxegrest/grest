...
interface Assets {
	...
	**/
	...
	function group(parent:String, body:grest.securitycenter.v1.types.GroupAssetsRequest):grest.securitycenter.v1.types.GroupAssetsResponse;
	/**
	...
	**/
	@:optional
	var readTime : String; }):grest.securitycenter.v1.types.ListAssetsResponse;
	/**
		Runs asset discovery. The discovery is tracked with a long-running operation. This API can only be called with limited frequency for an organization. If it is called too frequently the caller will receive a TOO_MANY_REQUESTS error.
	**/
	@:post("/v1/$parent/assets:runDiscovery")
	function runDiscovery(parent:String, body:grest.securitycenter.v1.types.RunAssetDiscoveryRequest):grest.securitycenter.v1.types.Operation;
	/**
