package grest.securitycenter.v1.api.organizations.sources;
interface Findings {
	/**
	...
	**/
	@:optional
	var findingId : String; }, body:grest.securitycenter.v1.types.Finding):grest.securitycenter.v1.types.Finding;
	/**
		Filters an organization or source's findings and groups them by their specified properties. To group across all sources provide a `-` as the source id. Example: /v1/organizations/{organization_id}/sources/-/findings, /v1/folders/{folder_id}/sources/-/findings, /v1/projects/{project_id}/sources/-/findings
	**/
	@:post("/v1/$parent/findings:group")
	function group(parent:String, body:grest.securitycenter.v1.types.GroupFindingsRequest):grest.securitycenter.v1.types.GroupFindingsResponse;
	/**
	...
	**/
	@:optional
	var readTime : String; }):grest.securitycenter.v1.types.ListFindingsResponse;
	/**
	...
	**/
	@:optional
	var updateMask : String; }, body:grest.securitycenter.v1.types.Finding):grest.securitycenter.v1.types.Finding;
	/**
		Updates the state of a finding.
	**/
	@:post("/v1/$name")
	function setState(name:grest.securitycenter.v1.types.Api_securitycenter_organizations_sources_findings_setState_name_Command, body:grest.securitycenter.v1.types.SetFindingStateRequest):grest.securitycenter.v1.types.Finding;
	/**
		Updates security marks.
	**/
	@:patch("/v1/$name")
	function updateSecurityMarks(name:String, query:{ /**
	...
	**/
	@:optional
	var updateMask : String; }, body:grest.securitycenter.v1.types.SecurityMarks):grest.securitycenter.v1.types.SecurityMarks;
}