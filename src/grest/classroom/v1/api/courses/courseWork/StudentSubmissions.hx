...
interface StudentSubmissions {
	...
	**/
	@:post("/v1/courses/$courseId/courseWork/$courseWorkId/studentSubmissions/$id")
	function return_(courseId:String, courseWorkId:String, id:grest.classroom.v1.types.Api_classroom_courses_courseWork_studentSubmissions_return_id_Command, body:grest.classroom.v1.types.ReturnStudentSubmissionRequest):grest.classroom.v1.types.Empty;
	/**
