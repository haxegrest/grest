...
interface Environments {
	...
	**/
	...
	function create(parent:String, body:grest.composer.v1.types.Environment):grest.composer.v1.types.Operation;
	/**
		Delete an environment.
	**/
	@:delete("/v1/$name")
	function delete(name:String):grest.composer.v1.types.Operation;
	/**
		Get an existing environment.
	**/
	@:get("/v1/$name")
	function get(name:String):grest.composer.v1.types.Environment;
	/**
		List environments.
	**/
	...
	**/
	@:optional
	var pageToken : String; }):grest.composer.v1.types.ListEnvironmentsResponse;
	/**
	...
	**/
	@:optional
	var updateMask : String; }, body:grest.composer.v1.types.Environment):grest.composer.v1.types.Operation;
}