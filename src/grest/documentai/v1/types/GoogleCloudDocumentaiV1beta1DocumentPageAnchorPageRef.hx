...
typedef GoogleCloudDocumentaiV1beta1DocumentPageAnchorPageRef = {
	/**
	...
	**/
	@:optional
	var layoutType : grest.documentai.v1.types.GoogleCloudDocumentaiV1beta1DocumentPageAnchorPageRef_layoutType;
	/**
