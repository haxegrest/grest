...
typedef GoogleCloudDocumentaiV1DocumentPageAnchorPageRef = {
	/**
	...
	**/
	@:optional
	var layoutType : grest.documentai.v1.types.GoogleCloudDocumentaiV1DocumentPageAnchorPageRef_layoutType;
	/**
