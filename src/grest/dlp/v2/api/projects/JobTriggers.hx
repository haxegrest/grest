...
interface JobTriggers {
	...
	**/
	@:post("/v2/$name")
	function activate(name:grest.dlp.v2.types.Api_dlp_projects_jobTriggers_activate_name_Command, body:grest.dlp.v2.types.GooglePrivacyDlpV2ActivateJobTriggerRequest):grest.dlp.v2.types.GooglePrivacyDlpV2DlpJob;
	/**
