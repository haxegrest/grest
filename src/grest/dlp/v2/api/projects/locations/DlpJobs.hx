...
interface DlpJobs {
	...
	**/
	@:post("/v2/$name")
	function cancel(name:grest.dlp.v2.types.Api_dlp_projects_locations_dlpJobs_cancel_name_Command, body:grest.dlp.v2.types.GooglePrivacyDlpV2CancelDlpJobRequest):grest.dlp.v2.types.GoogleProtobufEmpty;
	/**
	...
	**/
	@:post("/v2/$name")
	function finish(name:grest.dlp.v2.types.Api_dlp_projects_locations_dlpJobs_finish_name_Command, body:grest.dlp.v2.types.GooglePrivacyDlpV2FinishDlpJobRequest):grest.dlp.v2.types.GoogleProtobufEmpty;
	/**
	...
	**/
	@:post("/v2/$name")
	function hybridInspect(name:grest.dlp.v2.types.Api_dlp_projects_locations_dlpJobs_hybridInspect_name_Command, body:grest.dlp.v2.types.GooglePrivacyDlpV2HybridInspectDlpJobRequest):grest.dlp.v2.types.GooglePrivacyDlpV2HybridInspectResponse;
	/**
