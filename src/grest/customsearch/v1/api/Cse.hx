...
interface Cse {
	...
	**/
	@:optional
	var imgColorType : grest.customsearch.v1.types.Api_Cse_list_imgColorType; /**
	...
	**/
	@:optional
	var imgDominantColor : grest.customsearch.v1.types.Api_Cse_list_imgDominantColor; /**
		Returns images of a specified size. Acceptable values are: * `"huge"` * `"icon"` * `"large"` * `"medium"` * `"small"` * `"xlarge"` * `"xxlarge"`
	**/
	@:optional
	var imgSize : grest.customsearch.v1.types.Api_Cse_list_imgSize; /**
		Returns images of a type. Acceptable values are: * `"clipart"` * `"face"` * `"lineart"` * `"stock"` * `"photo"` * `"animated"`
	**/
	@:optional
	var imgType : grest.customsearch.v1.types.Api_Cse_list_imgType; /**
	...
	**/
	@:optional
	var safe : grest.customsearch.v1.types.Api_Cse_list_safe; /**
	...
	**/
	@:optional
	var searchType : grest.customsearch.v1.types.Api_Cse_list_searchType; /**
	...
	**/
	@:optional
	var siteSearchFilter : grest.customsearch.v1.types.Api_Cse_list_siteSearchFilter; /**
	...
	**/
	...
	@:sub("/")
	var siterestrict : grest.customsearch.v1.api.cse.Siterestrict;
}