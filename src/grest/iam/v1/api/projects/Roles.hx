...
interface Roles {
	...
	**/
	@:post("/v1/$name")
	function undelete(name:grest.iam.v1.types.Api_iam_projects_roles_undelete_name_Command, body:grest.iam.v1.types.UndeleteRoleRequest):grest.iam.v1.types.Role;
}