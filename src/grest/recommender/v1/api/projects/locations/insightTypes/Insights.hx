package grest.recommender.v1.api.projects.locations.insightTypes;
interface Insights {
	/**
	...
	**/
	@:post("/v1/$name")
	function markAccepted(name:grest.recommender.v1.types.Api_recommender_projects_locations_insightTypes_insights_markAccepted_name_Command, body:grest.recommender.v1.types.GoogleCloudRecommenderV1MarkInsightAcceptedRequest):grest.recommender.v1.types.GoogleCloudRecommenderV1Insight;
}