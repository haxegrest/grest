package grest.recommender.v1.api.billingAccounts.locations.recommenders;
interface Recommendations {
	...
	**/
	@:post("/v1/$name")
	function markClaimed(name:grest.recommender.v1.types.Api_recommender_billingAccounts_locations_recommenders_recommendations_markClaimed_name_Command, body:grest.recommender.v1.types.GoogleCloudRecommenderV1MarkRecommendationClaimedRequest):grest.recommender.v1.types.GoogleCloudRecommenderV1Recommendation;
	/**
		Marks the Recommendation State as Failed. Users can use this method to indicate to the Recommender API that they have applied the recommendation themselves, and the operation failed. This stops the recommendation content from being updated. Associated insights are frozen and placed in the ACCEPTED state. MarkRecommendationFailed can be applied to recommendations in ACTIVE, CLAIMED, SUCCEEDED, or FAILED state. Requires the recommender.*.update IAM permission for the specified recommender.
	**/
	@:post("/v1/$name")
	function markFailed(name:grest.recommender.v1.types.Api_recommender_billingAccounts_locations_recommenders_recommendations_markFailed_name_Command, body:grest.recommender.v1.types.GoogleCloudRecommenderV1MarkRecommendationFailedRequest):grest.recommender.v1.types.GoogleCloudRecommenderV1Recommendation;
	/**
		Marks the Recommendation State as Succeeded. Users can use this method to indicate to the Recommender API that they have applied the recommendation themselves, and the operation was successful. This stops the recommendation content from being updated. Associated insights are frozen and placed in the ACCEPTED state. MarkRecommendationSucceeded can be applied to recommendations in ACTIVE, CLAIMED, SUCCEEDED, or FAILED state. Requires the recommender.*.update IAM permission for the specified recommender.
	**/
	@:post("/v1/$name")
	function markSucceeded(name:grest.recommender.v1.types.Api_recommender_billingAccounts_locations_recommenders_recommendations_markSucceeded_name_Command, body:grest.recommender.v1.types.GoogleCloudRecommenderV1MarkRecommendationSucceededRequest):grest.recommender.v1.types.GoogleCloudRecommenderV1Recommendation;
}