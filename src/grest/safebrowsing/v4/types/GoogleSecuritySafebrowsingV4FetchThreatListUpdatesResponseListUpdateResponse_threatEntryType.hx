...
@:enum abstract GoogleSecuritySafebrowsingV4FetchThreatListUpdatesResponseListUpdateResponse_threatEntryType(String) from String to String to tink.Stringly {
	var CERT = "CERT";
