...
@:enum abstract GoogleSecuritySafebrowsingV4FetchThreatListUpdatesRequestListUpdateRequest_threatEntryType(String) from String to String to tink.Stringly {
	var CERT = "CERT";
