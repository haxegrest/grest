...
typedef JobConfigurationLoad = {
	...
	**/
	@:optional
	var allowJaggedRows : Bool;
	/**
		Indicates if BigQuery should allow quoted data sections that contain newline characters in a CSV file. The default value is false.
	**/
	@:optional
	var allowQuotedNewlines : Bool;
	/**
	...
	**/
	@:optional
	var destinationTableProperties : DestinationTableProperties;
	/**
	...
	**/
	@:optional
	var projectionFields : Array<String>;
	/**
