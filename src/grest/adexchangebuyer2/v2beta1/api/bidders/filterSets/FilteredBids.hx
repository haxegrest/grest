...
interface FilteredBids {
	@:sub("/")
	var creatives : grest.adexchangebuyer2.v2beta1.api.bidders.filterSets.filteredBids.Creatives;
	@:sub("/")
	var details : grest.adexchangebuyer2.v2beta1.api.bidders.filterSets.filteredBids.Details;
	/**
