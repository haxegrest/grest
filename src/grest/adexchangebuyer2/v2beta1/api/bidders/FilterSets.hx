package grest.adexchangebuyer2.v2beta1.api.bidders;
interface FilterSets {
	@:sub("/")
	var bidMetrics : grest.adexchangebuyer2.v2beta1.api.bidders.filterSets.BidMetrics;
	@:sub("/")
	var bidResponseErrors : grest.adexchangebuyer2.v2beta1.api.bidders.filterSets.BidResponseErrors;
	@:sub("/")
	var bidResponsesWithoutBids : grest.adexchangebuyer2.v2beta1.api.bidders.filterSets.BidResponsesWithoutBids;
	/**
	...
	**/
	...
	@:sub("/")
	var filteredBidRequests : grest.adexchangebuyer2.v2beta1.api.bidders.filterSets.FilteredBidRequests;
	@:sub("/")
	var filteredBids : grest.adexchangebuyer2.v2beta1.api.bidders.filterSets.FilteredBids;
	/**
	...
	**/
	...
	@:sub("/")
	var impressionMetrics : grest.adexchangebuyer2.v2beta1.api.bidders.filterSets.ImpressionMetrics;
	/**
	...
	**/
	...
	@:sub("/")
	var losingBids : grest.adexchangebuyer2.v2beta1.api.bidders.filterSets.LosingBids;
	@:sub("/")
	var nonBillableWinningBids : grest.adexchangebuyer2.v2beta1.api.bidders.filterSets.NonBillableWinningBids;
}