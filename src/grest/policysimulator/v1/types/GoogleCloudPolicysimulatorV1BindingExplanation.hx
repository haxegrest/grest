...
typedef GoogleCloudPolicysimulatorV1BindingExplanation = {
	/**
	...
	**/
	@:optional
	var access : grest.policysimulator.v1.types.GoogleCloudPolicysimulatorV1BindingExplanation_access;
	/**
	...
	**/
	@:optional
	var memberships : haxe.DynamicAccess<GoogleCloudPolicysimulatorV1BindingExplanationAnnotatedMembership>;
	/**
		The relevance of this binding to the overall determination for the entire policy.
	**/
	@:optional
	var relevance : grest.policysimulator.v1.types.GoogleCloudPolicysimulatorV1BindingExplanation_relevance;
	/**
	...
	**/
	@:optional
	var rolePermission : grest.policysimulator.v1.types.GoogleCloudPolicysimulatorV1BindingExplanation_rolePermission;
	/**
		The relevance of the permission's existence, or nonexistence, in the role to the overall determination for the entire policy.
	**/
	@:optional
	var rolePermissionRelevance : grest.policysimulator.v1.types.GoogleCloudPolicysimulatorV1BindingExplanation_rolePermissionRelevance;
}