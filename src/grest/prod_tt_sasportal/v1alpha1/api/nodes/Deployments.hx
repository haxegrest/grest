...
interface Deployments {
	...
	**/
	...
	@:sub("/")
	var devices : grest.prod_tt_sasportal.v1alpha1.api.nodes.deployments.Devices;
	/**
	...
	**/
	@:post("/v1alpha1/$name")
	function move(name:grest.prod_tt_sasportal.v1alpha1.types.Api_prod_tt_sasportal_nodes_deployments_move_name_Command, body:grest.prod_tt_sasportal.v1alpha1.types.SasPortalMoveDeploymentRequest):grest.prod_tt_sasportal.v1alpha1.types.SasPortalOperation;
	/**
