...
interface Nodes {
	...
	**/
	...
	@:sub("/")
	var deployments : grest.prod_tt_sasportal.v1alpha1.api.customers.nodes.Deployments;
	@:sub("/")
	var devices : grest.prod_tt_sasportal.v1alpha1.api.customers.nodes.Devices;
	/**
	...
	**/
	@:post("/v1alpha1/$name")
	function move(name:grest.prod_tt_sasportal.v1alpha1.types.Api_prod_tt_sasportal_customers_nodes_move_name_Command, body:grest.prod_tt_sasportal.v1alpha1.types.SasPortalMoveNodeRequest):grest.prod_tt_sasportal.v1alpha1.types.SasPortalOperation;
	@:sub("/")
	var nodes : grest.prod_tt_sasportal.v1alpha1.api.customers.nodes.Nodes;
	/**
