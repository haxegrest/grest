...
interface Devices {
	...
	**/
	@:post("/v1alpha1/$name")
	function move(name:grest.prod_tt_sasportal.v1alpha1.types.Api_prod_tt_sasportal_customers_devices_move_name_Command, body:grest.prod_tt_sasportal.v1alpha1.types.SasPortalMoveDeviceRequest):grest.prod_tt_sasportal.v1alpha1.types.SasPortalOperation;
	/**
		Updates a device.
	**/
	@:patch("/v1alpha1/$name")
	...
	**/
	@:post("/v1alpha1/$name")
	function signDevice(name:grest.prod_tt_sasportal.v1alpha1.types.Api_prod_tt_sasportal_customers_devices_signDevice_name_Command, body:grest.prod_tt_sasportal.v1alpha1.types.SasPortalSignDeviceRequest):grest.prod_tt_sasportal.v1alpha1.types.SasPortalEmpty;
	/**
		Updates a signed device.
	**/
	@:patch("/v1alpha1/$name")
	function updateSigned(name:grest.prod_tt_sasportal.v1alpha1.types.Api_prod_tt_sasportal_customers_devices_updateSigned_name_Command, body:grest.prod_tt_sasportal.v1alpha1.types.SasPortalUpdateSignedDeviceRequest):grest.prod_tt_sasportal.v1alpha1.types.SasPortalDevice;
}