...
typedef SasPortalDeviceGrant = {
	...
	**/
	@:optional
	var channelType : grest.prod_tt_sasportal.v1alpha1.types.SasPortalDeviceGrant_channelType;
	/**
	...
	**/
	@:optional
	var state : grest.prod_tt_sasportal.v1alpha1.types.SasPortalDeviceGrant_state;
	/**
