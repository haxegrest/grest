...
interface FhirStores {
	...
	**/
	@:post("/v1/$name")
	function import(name:grest.healthcare.v1.types.Api_healthcare_projects_locations_datasets_fhirStores_import_name_Command, body:grest.healthcare.v1.types.ImportResourcesRequest):grest.healthcare.v1.types.Operation;
	/**
