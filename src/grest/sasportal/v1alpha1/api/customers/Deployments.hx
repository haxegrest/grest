...
interface Deployments {
	...
	**/
	...
	@:sub("/")
	var devices : grest.sasportal.v1alpha1.api.customers.deployments.Devices;
	/**
	...
	**/
	@:post("/v1alpha1/$name")
	function move(name:grest.sasportal.v1alpha1.types.Api_sasportal_customers_deployments_move_name_Command, body:grest.sasportal.v1alpha1.types.SasPortalMoveDeploymentRequest):grest.sasportal.v1alpha1.types.SasPortalOperation;
	/**
