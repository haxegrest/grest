...
interface Nodes {
	...
	**/
	...
	@:sub("/")
	var deployments : grest.sasportal.v1alpha1.api.nodes.nodes.Deployments;
	@:sub("/")
	var devices : grest.sasportal.v1alpha1.api.nodes.nodes.Devices;
	/**
	...
	**/
	@:post("/v1alpha1/$name")
	function move(name:grest.sasportal.v1alpha1.types.Api_sasportal_nodes_nodes_move_name_Command, body:grest.sasportal.v1alpha1.types.SasPortalMoveNodeRequest):grest.sasportal.v1alpha1.types.SasPortalOperation;
	@:sub("/")
	var nodes : grest.sasportal.v1alpha1.api.nodes.nodes.Nodes;
	/**
