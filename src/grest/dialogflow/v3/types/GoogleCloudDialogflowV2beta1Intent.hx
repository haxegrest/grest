...
typedef GoogleCloudDialogflowV2beta1Intent = {
	...
	**/
	@:optional
	var followupIntentInfo : Array<GoogleCloudDialogflowV2beta1IntentFollowupIntentInfo>;
	/**
	...
	**/
	@:optional
	var messages : Array<GoogleCloudDialogflowV2beta1IntentMessage>;
	/**
	...
	**/
	@:optional
	var parameters : Array<GoogleCloudDialogflowV2beta1IntentParameter>;
	/**
	...
	**/
	@:optional
	var trainingPhrases : Array<GoogleCloudDialogflowV2beta1IntentTrainingPhrase>;
	/**
		Optional. Indicates whether webhooks are enabled for the intent.
	**/
	@:optional
	var webhookState : grest.dialogflow.v3.types.GoogleCloudDialogflowV2beta1Intent_webhookState;
}