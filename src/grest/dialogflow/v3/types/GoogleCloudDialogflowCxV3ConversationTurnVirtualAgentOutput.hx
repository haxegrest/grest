...
typedef GoogleCloudDialogflowCxV3ConversationTurnVirtualAgentOutput = {
	/**
	...
	**/
	@:optional
	var differences : Array<GoogleCloudDialogflowCxV3TestRunDifference>;
	/**
	...
	**/
	@:optional
	var textResponses : Array<GoogleCloudDialogflowCxV3ResponseMessageText>;
	/**
		The Intent that triggered the response. Only name and displayName will be set.
	**/
	@:optional
	var triggeredIntent : GoogleCloudDialogflowCxV3Intent;
}