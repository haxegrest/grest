...
typedef GoogleCloudDialogflowCxV3InputAudioConfig = {
	/**
		Required. Audio encoding of the audio content to process.
	**/
	@:optional
	var audioEncoding : grest.dialogflow.v3.types.GoogleCloudDialogflowCxV3InputAudioConfig_audioEncoding;
	/**
	...
	**/
	@:optional
	var modelVariant : grest.dialogflow.v3.types.GoogleCloudDialogflowCxV3InputAudioConfig_modelVariant;
	/**
