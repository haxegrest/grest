...
typedef GoogleCloudDialogflowCxV3beta1WebhookRequestIntentInfo = {
	/**
	...
	**/
	@:optional
	var parameters : haxe.DynamicAccess<GoogleCloudDialogflowCxV3beta1WebhookRequestIntentInfoIntentParameterValue>;
}