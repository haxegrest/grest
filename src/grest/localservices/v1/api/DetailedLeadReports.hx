...
interface DetailedLeadReports {
	...
	**/
	@:optional
	var startDate.year : Int; }):grest.localservices.v1.types.GoogleAdsHomeservicesLocalservicesV1SearchDetailedLeadReportsResponse;
}