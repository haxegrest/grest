...
interface Operations {
	...
	**/
	...
	function get(project:String, operation:String):grest.deploymentmanager.v2.types.Operation;
	/**
	...
	**/
	@:optional
	var pageToken : String; }):grest.deploymentmanager.v2.types.OperationsListResponse;
}