...
interface DataSources {
	...
	**/
	@:post("/v1/$name")
	function checkValidCreds(name:grest.bigquerydatatransfer.v1.types.Api_bigquerydatatransfer_projects_dataSources_checkValidCreds_name_Command, body:grest.bigquerydatatransfer.v1.types.CheckValidCredsRequest):grest.bigquerydatatransfer.v1.types.CheckValidCredsResponse;
	/**
