package grest.bigquerydatatransfer.v1.api.projects.transferConfigs;
interface Runs {
	/**
	...
	**/
	...
	@:sub("/")
	var transferLogs : grest.bigquerydatatransfer.v1.api.projects.transferConfigs.runs.TransferLogs;
}