...
interface Folders {
	...
	**/
	@:post("/v3/folders")
	function create(body:grest.cloudresourcemanager.v3.types.Folder):grest.cloudresourcemanager.v3.types.Operation;
	/**
	...
	**/
	@:get("/v3/$name")
	function get(name:String):grest.cloudresourcemanager.v3.types.Folder;
	/**
	...
	**/
	@:post("/v3/$resource")
	function getIamPolicy(resource:grest.cloudresourcemanager.v3.types.Api_cloudresourcemanager_folders_getIamPolicy_resource_Command, body:grest.cloudresourcemanager.v3.types.GetIamPolicyRequest):grest.cloudresourcemanager.v3.types.Policy;
	/**
	...
	**/
	@:optional
	var showDeleted : Bool; }):grest.cloudresourcemanager.v3.types.ListFoldersResponse;
	/**
	...
	**/
	@:post("/v3/$name")
	function move(name:grest.cloudresourcemanager.v3.types.Api_cloudresourcemanager_folders_move_name_Command, body:grest.cloudresourcemanager.v3.types.MoveFolderRequest):grest.cloudresourcemanager.v3.types.Operation;
	/**
	...
	**/
	@:optional
	var updateMask : String; }, body:grest.cloudresourcemanager.v3.types.Folder):grest.cloudresourcemanager.v3.types.Operation;
	/**
	...
	**/
	@:optional
	var query : String; }):grest.cloudresourcemanager.v3.types.SearchFoldersResponse;
	/**
	...
	**/
	@:post("/v3/$resource")
	function setIamPolicy(resource:grest.cloudresourcemanager.v3.types.Api_cloudresourcemanager_folders_setIamPolicy_resource_Command, body:grest.cloudresourcemanager.v3.types.SetIamPolicyRequest):grest.cloudresourcemanager.v3.types.Policy;
	/**
	...
	**/
	@:post("/v3/$resource")
	function testIamPermissions(resource:grest.cloudresourcemanager.v3.types.Api_cloudresourcemanager_folders_testIamPermissions_resource_Command, body:grest.cloudresourcemanager.v3.types.TestIamPermissionsRequest):grest.cloudresourcemanager.v3.types.TestIamPermissionsResponse;
	/**
		Cancels the deletion request for a folder. This method may be called on a folder in any state. If the folder is in the ACTIVE state the result will be a no-op success. In order to succeed, the folder's parent must be in the ACTIVE state. In addition, reintroducing the folder into the tree must not violate folder naming, height, and fanout constraints described in the CreateFolder documentation. The caller must have `resourcemanager.folders.undelete` permission on the identified folder.
	**/
	@:post("/v3/$name")
	function undelete(name:grest.cloudresourcemanager.v3.types.Api_cloudresourcemanager_folders_undelete_name_Command, body:grest.cloudresourcemanager.v3.types.UndeleteFolderRequest):grest.cloudresourcemanager.v3.types.Operation;
}