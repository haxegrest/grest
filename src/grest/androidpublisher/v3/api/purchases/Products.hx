...
interface Products {
	...
	**/
	...
	function acknowledge(packageName:String, productId:String, token:grest.androidpublisher.v3.types.Api_androidpublisher_purchases_products_acknowledge_token_Command, body:grest.androidpublisher.v3.types.ProductPurchasesAcknowledgeRequest):Void;
	/**
