...
interface Autoscalers {
	...
	**/
	@:optional
	var returnPartialSuccess : Bool; }):grest.compute.v1.types.AutoscalerAggregatedList;
	/**
		Deletes the specified autoscaler.
	**/
	@:delete("/compute/v1/projects/$project/zones/$zone/autoscalers/$autoscaler")
	function delete(project:String, zone:String, autoscaler:String, query:{ /**
	...
	**/
	...
	function get(project:String, zone:String, autoscaler:String):grest.compute.v1.types.Autoscaler;
	/**
	...
	**/
	@:optional
	var requestId : String; }, body:grest.compute.v1.types.Autoscaler):grest.compute.v1.types.Operation;
	/**
	...
	**/
	@:optional
	var returnPartialSuccess : Bool; }):grest.compute.v1.types.AutoscalerList;
	/**
		Updates an autoscaler in the specified project using the data included in the request. This method supports PATCH semantics and uses the JSON merge patch format and processing rules.
	**/
	@:patch("/compute/v1/projects/$project/zones/$zone/autoscalers")
	function patch(project:String, zone:String, query:{ /**
	...
	**/
	...
	function update(project:String, zone:String, query:{ /**
