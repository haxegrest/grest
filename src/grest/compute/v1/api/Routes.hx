...
interface Routes {
	...
	**/
	...
	function delete(project:String, route:String, query:{ /**
	...
	**/
	...
	function get(project:String, route:String):grest.compute.v1.types.Route;
	/**
	...
	**/
	@:optional
	var requestId : String; }, body:grest.compute.v1.types.Route):grest.compute.v1.types.Operation;
	/**
	...
	**/
	@:optional
	var returnPartialSuccess : Bool; }):grest.compute.v1.types.RouteList;
}