...
interface GlobalOperations {
	...
	**/
	@:optional
	var returnPartialSuccess : Bool; }):grest.compute.v1.types.OperationAggregatedList;
	/**
		Deletes the specified Operations resource.
	**/
	@:delete("/compute/v1/projects/$project/global/operations/$operation")
	function delete(project:String, operation:String):tink.core.Noise;
	/**
		Retrieves the specified Operations resource. Gets a list of operations by making a `list()` request.
	**/
	@:get("/compute/v1/projects/$project/global/operations/$operation")
	function get(project:String, operation:String):grest.compute.v1.types.Operation;
	/**
	...
	**/
	...
	function wait(project:String, operation:String):grest.compute.v1.types.Operation;
}