...
interface TargetVpnGateways {
	...
	**/
	@:optional
	var returnPartialSuccess : Bool; }):grest.compute.v1.types.TargetVpnGatewayAggregatedList;
	/**
		Deletes the specified target VPN gateway.
	**/
	@:delete("/compute/v1/projects/$project/regions/$region/targetVpnGateways/$targetVpnGateway")
	function delete(project:String, region:String, targetVpnGateway:String, query:{ /**
	...
	**/
	...
	function get(project:String, region:String, targetVpnGateway:String):grest.compute.v1.types.TargetVpnGateway;
	/**
	...
	**/
	@:optional
	var requestId : String; }, body:grest.compute.v1.types.TargetVpnGateway):grest.compute.v1.types.Operation;
	/**
	...
	**/
	@:optional
	var returnPartialSuccess : Bool; }):grest.compute.v1.types.TargetVpnGatewayList;
}