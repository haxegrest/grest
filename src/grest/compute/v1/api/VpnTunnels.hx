...
interface VpnTunnels {
	...
	**/
	@:optional
	var returnPartialSuccess : Bool; }):grest.compute.v1.types.VpnTunnelAggregatedList;
	/**
		Deletes the specified VpnTunnel resource.
	**/
	@:delete("/compute/v1/projects/$project/regions/$region/vpnTunnels/$vpnTunnel")
	function delete(project:String, region:String, vpnTunnel:String, query:{ /**
	...
	**/
	...
	function get(project:String, region:String, vpnTunnel:String):grest.compute.v1.types.VpnTunnel;
	/**
	...
	**/
	@:optional
	var requestId : String; }, body:grest.compute.v1.types.VpnTunnel):grest.compute.v1.types.Operation;
	/**
	...
	**/
	@:optional
	var returnPartialSuccess : Bool; }):grest.compute.v1.types.VpnTunnelList;
}