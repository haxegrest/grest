...
interface RegionAutoscalers {
	/**
		Deletes the specified autoscaler.
	**/
	@:delete("/compute/v1/projects/$project/regions/$region/autoscalers/$autoscaler")
	function delete(project:String, region:String, autoscaler:String, query:{ /**
	...
	**/
	...
	function get(project:String, region:String, autoscaler:String):grest.compute.v1.types.Autoscaler;
	/**
	...
	**/
	@:optional
	var returnPartialSuccess : Bool; }):grest.compute.v1.types.RegionAutoscalerList;
	/**
		Updates an autoscaler in the specified project using the data included in the request. This method supports PATCH semantics and uses the JSON merge patch format and processing rules.
	**/
	@:patch("/compute/v1/projects/$project/regions/$region/autoscalers")
	function patch(project:String, region:String, query:{ /**
	...
	**/
	...
	function update(project:String, region:String, query:{ /**
