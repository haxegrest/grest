...
interface MachineTypes {
	...
	**/
	@:optional
	var returnPartialSuccess : Bool; }):grest.compute.v1.types.MachineTypeAggregatedList;
	/**
		Returns the specified machine type. Gets a list of available machine types by making a list() request.
	**/
	@:get("/compute/v1/projects/$project/zones/$zone/machineTypes/$machineType")
	function get(project:String, zone:String, machineType:String):grest.compute.v1.types.MachineType;
	/**
	...
	**/
	@:optional
	var returnPartialSuccess : Bool; }):grest.compute.v1.types.MachineTypeList;
}