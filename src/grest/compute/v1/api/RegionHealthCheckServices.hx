...
interface RegionHealthCheckServices {
	/**
		Deletes the specified regional HealthCheckService.
	**/
	@:delete("/compute/v1/projects/$project/regions/$region/healthCheckServices/$healthCheckService")
	function delete(project:String, region:String, healthCheckService:String, query:{ /**
	...
	**/
	...
	function get(project:String, region:String, healthCheckService:String):grest.compute.v1.types.HealthCheckService;
	/**
	...
	**/
	@:optional
	var requestId : String; }, body:grest.compute.v1.types.HealthCheckService):grest.compute.v1.types.Operation;
	/**
	...
	**/
	@:optional
	var returnPartialSuccess : Bool; }):grest.compute.v1.types.HealthCheckServicesList;
	/**
	...
	**/
	...
	function patch(project:String, region:String, healthCheckService:String, query:{ /**
		An optional request ID to identify requests. Specify a unique request ID so that if you must retry your request, the server will know to ignore the request if it has already been completed.
