...
interface RegionNetworkEndpointGroups {
	...
	**/
	...
	function get(project:String, region:String, networkEndpointGroup:String):grest.compute.v1.types.NetworkEndpointGroup;
	/**
