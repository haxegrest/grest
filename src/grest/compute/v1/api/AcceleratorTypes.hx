...
interface AcceleratorTypes {
	...
	**/
	@:optional
	var returnPartialSuccess : Bool; }):grest.compute.v1.types.AcceleratorTypeAggregatedList;
	/**
		Returns the specified accelerator type.
	**/
	@:get("/compute/v1/projects/$project/zones/$zone/acceleratorTypes/$acceleratorType")
	function get(project:String, zone:String, acceleratorType:String):grest.compute.v1.types.AcceleratorType;
	/**
	...
	**/
	@:optional
	var returnPartialSuccess : Bool; }):grest.compute.v1.types.AcceleratorTypeList;
}