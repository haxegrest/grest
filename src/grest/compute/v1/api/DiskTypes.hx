...
interface DiskTypes {
	...
	**/
	@:optional
	var returnPartialSuccess : Bool; }):grest.compute.v1.types.DiskTypeAggregatedList;
	/**
		Returns the specified disk type. Gets a list of available disk types by making a list() request.
	**/
	@:get("/compute/v1/projects/$project/zones/$zone/diskTypes/$diskType")
	function get(project:String, zone:String, diskType:String):grest.compute.v1.types.DiskType;
	/**
	...
	**/
	@:optional
	var returnPartialSuccess : Bool; }):grest.compute.v1.types.DiskTypeList;
}