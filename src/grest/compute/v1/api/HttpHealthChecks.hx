...
interface HttpHealthChecks {
	/**
		Deletes the specified HttpHealthCheck resource.
	**/
	@:delete("/compute/v1/projects/$project/global/httpHealthChecks/$httpHealthCheck")
	function delete(project:String, httpHealthCheck:String, query:{ /**
	...
	**/
	...
	function get(project:String, httpHealthCheck:String):grest.compute.v1.types.HttpHealthCheck;
	/**
	...
	**/
	@:optional
	var requestId : String; }, body:grest.compute.v1.types.HttpHealthCheck):grest.compute.v1.types.Operation;
	/**
	...
	**/
	@:optional
	var returnPartialSuccess : Bool; }):grest.compute.v1.types.HttpHealthCheckList;
	/**
		Updates a HttpHealthCheck resource in the specified project using the data included in the request. This method supports PATCH semantics and uses the JSON merge patch format and processing rules.
	**/
	@:patch("/compute/v1/projects/$project/global/httpHealthChecks/$httpHealthCheck")
	function patch(project:String, httpHealthCheck:String, query:{ /**
		An optional request ID to identify requests. Specify a unique request ID so that if you must retry your request, the server will know to ignore the request if it has already been completed.
	...
	**/
	...
	function update(project:String, httpHealthCheck:String, query:{ /**
		An optional request ID to identify requests. Specify a unique request ID so that if you must retry your request, the server will know to ignore the request if it has already been completed.
