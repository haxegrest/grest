...
interface Firewalls {
	...
	**/
	...
	function delete(project:String, firewall:String, query:{ /**
	...
	**/
	...
	function get(project:String, firewall:String):grest.compute.v1.types.Firewall;
	/**
	...
	**/
	@:optional
	var requestId : String; }, body:grest.compute.v1.types.Firewall):grest.compute.v1.types.Operation;
	/**
	...
	**/
	@:optional
	var returnPartialSuccess : Bool; }):grest.compute.v1.types.FirewallList;
	/**
		Updates the specified firewall rule with the data included in the request. This method supports PATCH semantics and uses the JSON merge patch format and processing rules.
	**/
	@:patch("/compute/v1/projects/$project/global/firewalls/$firewall")
	function patch(project:String, firewall:String, query:{ /**
		An optional request ID to identify requests. Specify a unique request ID so that if you must retry your request, the server will know to ignore the request if it has already been completed.
	...
	**/
	...
	function update(project:String, firewall:String, query:{ /**
		An optional request ID to identify requests. Specify a unique request ID so that if you must retry your request, the server will know to ignore the request if it has already been completed.
