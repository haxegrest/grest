...
interface SslCertificates {
	...
	**/
	@:optional
	var returnPartialSuccess : Bool; }):grest.compute.v1.types.SslCertificateAggregatedList;
	/**
		Deletes the specified SslCertificate resource.
	**/
	@:delete("/compute/v1/projects/$project/global/sslCertificates/$sslCertificate")
	function delete(project:String, sslCertificate:String, query:{ /**
	...
	**/
	...
	function get(project:String, sslCertificate:String):grest.compute.v1.types.SslCertificate;
	/**
