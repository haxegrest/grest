...
interface RegionNotificationEndpoints {
	/**
		Deletes the specified NotificationEndpoint in the given region
	**/
	@:delete("/compute/v1/projects/$project/regions/$region/notificationEndpoints/$notificationEndpoint")
	function delete(project:String, region:String, notificationEndpoint:String, query:{ /**
	...
	**/
	...
	function get(project:String, region:String, notificationEndpoint:String):grest.compute.v1.types.NotificationEndpoint;
	/**
	...
	**/
	@:optional
	var requestId : String; }, body:grest.compute.v1.types.NotificationEndpoint):grest.compute.v1.types.Operation;
	/**
	...
	**/
	@:optional
	var returnPartialSuccess : Bool; }):grest.compute.v1.types.NotificationEndpointList;
}