...
interface NodeTemplates {
	...
	**/
	@:optional
	var returnPartialSuccess : Bool; }):grest.compute.v1.types.NodeTemplateAggregatedList;
	/**
		Deletes the specified NodeTemplate resource.
	**/
	@:delete("/compute/v1/projects/$project/regions/$region/nodeTemplates/$nodeTemplate")
	function delete(project:String, region:String, nodeTemplate:String, query:{ /**
	...
	**/
	...
	function get(project:String, region:String, nodeTemplate:String):grest.compute.v1.types.NodeTemplate;
	/**
	...
	**/
	@:optional
	var requestId : String; }, body:grest.compute.v1.types.NodeTemplate):grest.compute.v1.types.Operation;
	/**
	...
	**/
	@:optional
	var returnPartialSuccess : Bool; }):grest.compute.v1.types.NodeTemplateList;
	/**
