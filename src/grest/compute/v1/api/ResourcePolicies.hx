...
interface ResourcePolicies {
	...
	**/
	@:optional
	var returnPartialSuccess : Bool; }):grest.compute.v1.types.ResourcePolicyAggregatedList;
	/**
		Deletes the specified resource policy.
	**/
	@:delete("/compute/v1/projects/$project/regions/$region/resourcePolicies/$resourcePolicy")
	function delete(project:String, region:String, resourcePolicy:String, query:{ /**
	...
	**/
	...
	function get(project:String, region:String, resourcePolicy:String):grest.compute.v1.types.ResourcePolicy;
	/**
	...
	**/
	@:optional
	var requestId : String; }, body:grest.compute.v1.types.ResourcePolicy):grest.compute.v1.types.Operation;
	/**
	...
	**/
	@:optional
	var returnPartialSuccess : Bool; }):grest.compute.v1.types.ResourcePolicyList;
	/**
