...
interface RegionHealthChecks {
	/**
		Deletes the specified HealthCheck resource.
	**/
	@:delete("/compute/v1/projects/$project/regions/$region/healthChecks/$healthCheck")
	function delete(project:String, region:String, healthCheck:String, query:{ /**
	...
	**/
	...
	function get(project:String, region:String, healthCheck:String):grest.compute.v1.types.HealthCheck;
	/**
	...
	**/
	@:optional
	var requestId : String; }, body:grest.compute.v1.types.HealthCheck):grest.compute.v1.types.Operation;
	/**
	...
	**/
	@:optional
	var returnPartialSuccess : Bool; }):grest.compute.v1.types.HealthCheckList;
	/**
		Updates a HealthCheck resource in the specified project using the data included in the request. This method supports PATCH semantics and uses the JSON merge patch format and processing rules.
	**/
	@:patch("/compute/v1/projects/$project/regions/$region/healthChecks/$healthCheck")
	function patch(project:String, region:String, healthCheck:String, query:{ /**
		An optional request ID to identify requests. Specify a unique request ID so that if you must retry your request, the server will know to ignore the request if it has already been completed.
	...
	**/
	...
	function update(project:String, region:String, healthCheck:String, query:{ /**
		An optional request ID to identify requests. Specify a unique request ID so that if you must retry your request, the server will know to ignore the request if it has already been completed.
