...
interface BackendServices {
	...
	**/
	...
	function addSignedUrlKey(project:String, backendService:String, query:{ /**
	...
	**/
	@:optional
	var returnPartialSuccess : Bool; }):grest.compute.v1.types.BackendServiceAggregatedList;
	/**
		Deletes the specified BackendService resource.
	**/
	@:delete("/compute/v1/projects/$project/global/backendServices/$backendService")
	function delete(project:String, backendService:String, query:{ /**
		An optional request ID to identify requests. Specify a unique request ID so that if you must retry your request, the server will know to ignore the request if it has already been completed. For example, consider a situation where you make an initial request and the request times out. If you make the request again with the same request ID, the server can check if original operation with the same request ID was received, and if so, will ignore the second request. This prevents clients from accidentally creating duplicate commitments. The request ID must be a valid UUID with the exception that zero UUID is not supported ( 00000000-0000-0000-0000-000000000000).
	**/
	@:optional
	...
	**/
	...
	function deleteSignedUrlKey(project:String, backendService:String, query:{ /**
	...
	**/
	...
	function get(project:String, backendService:String):grest.compute.v1.types.BackendService;
	/**
		Gets the most recent health check results for this BackendService. Example request body: { "group": "/zones/us-east1-b/instanceGroups/lb-backend-example" }
	**/
	@:post("/compute/v1/projects/$project/global/backendServices/$backendService/getHealth")
	function getHealth(project:String, backendService:String, body:grest.compute.v1.types.ResourceGroupReference):grest.compute.v1.types.BackendServiceGroupHealth;
	/**
	...
	**/
	@:optional
	var requestId : String; }, body:grest.compute.v1.types.BackendService):grest.compute.v1.types.Operation;
	/**
	...
	**/
	@:optional
	var returnPartialSuccess : Bool; }):grest.compute.v1.types.BackendServiceList;
	/**
		Patches the specified BackendService resource with the data included in the request. For more information, see Backend services overview. This method supports PATCH semantics and uses the JSON merge patch format and processing rules.
	**/
	@:patch("/compute/v1/projects/$project/global/backendServices/$backendService")
	function patch(project:String, backendService:String, query:{ /**
		An optional request ID to identify requests. Specify a unique request ID so that if you must retry your request, the server will know to ignore the request if it has already been completed. For example, consider a situation where you make an initial request and the request times out. If you make the request again with the same request ID, the server can check if original operation with the same request ID was received, and if so, will ignore the second request. This prevents clients from accidentally creating duplicate commitments. The request ID must be a valid UUID with the exception that zero UUID is not supported ( 00000000-0000-0000-0000-000000000000).
	**/
	@:optional
	var requestId : String; }, body:grest.compute.v1.types.BackendService):grest.compute.v1.types.Operation;
	...
	**/
	...
	function setSecurityPolicy(project:String, backendService:String, query:{ /**
		An optional request ID to identify requests. Specify a unique request ID so that if you must retry your request, the server will know to ignore the request if it has already been completed. For example, consider a situation where you make an initial request and the request times out. If you make the request again with the same request ID, the server can check if original operation with the same request ID was received, and if so, will ignore the second request. This prevents clients from accidentally creating duplicate commitments. The request ID must be a valid UUID with the exception that zero UUID is not supported ( 00000000-0000-0000-0000-000000000000).
	**/
	@:optional
	var requestId : String; }, body:grest.compute.v1.types.SecurityPolicyReference):grest.compute.v1.types.Operation;
	/**
		Updates the specified BackendService resource with the data included in the request. For more information, see Backend services overview.
	**/
	@:put("/compute/v1/projects/$project/global/backendServices/$backendService")
	function update(project:String, backendService:String, query:{ /**
		An optional request ID to identify requests. Specify a unique request ID so that if you must retry your request, the server will know to ignore the request if it has already been completed. For example, consider a situation where you make an initial request and the request times out. If you make the request again with the same request ID, the server can check if original operation with the same request ID was received, and if so, will ignore the second request. This prevents clients from accidentally creating duplicate commitments. The request ID must be a valid UUID with the exception that zero UUID is not supported ( 00000000-0000-0000-0000-000000000000).
	**/
	@:optional
	var requestId : String; }, body:grest.compute.v1.types.BackendService):grest.compute.v1.types.Operation;
