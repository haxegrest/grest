...
interface ExternalVpnGateways {
	/**
		Deletes the specified externalVpnGateway.
	**/
	@:delete("/compute/v1/projects/$project/global/externalVpnGateways/$externalVpnGateway")
	function delete(project:String, externalVpnGateway:String, query:{ /**
	...
	**/
	...
	function get(project:String, externalVpnGateway:String):grest.compute.v1.types.ExternalVpnGateway;
	/**
	...
	**/
	@:optional
	var requestId : String; }, body:grest.compute.v1.types.ExternalVpnGateway):grest.compute.v1.types.Operation;
	/**
	...
	**/
	@:optional
	var returnPartialSuccess : Bool; }):grest.compute.v1.types.ExternalVpnGatewayList;
	/**
