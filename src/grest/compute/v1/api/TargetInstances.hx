...
interface TargetInstances {
	...
	**/
	@:optional
	var returnPartialSuccess : Bool; }):grest.compute.v1.types.TargetInstanceAggregatedList;
	/**
		Deletes the specified TargetInstance resource.
	**/
	@:delete("/compute/v1/projects/$project/zones/$zone/targetInstances/$targetInstance")
	function delete(project:String, zone:String, targetInstance:String, query:{ /**
	...
	**/
	...
	function get(project:String, zone:String, targetInstance:String):grest.compute.v1.types.TargetInstance;
	/**
	...
	**/
	@:optional
	var requestId : String; }, body:grest.compute.v1.types.TargetInstance):grest.compute.v1.types.Operation;
	/**
	...
	**/
	@:optional
	var returnPartialSuccess : Bool; }):grest.compute.v1.types.TargetInstanceList;
}