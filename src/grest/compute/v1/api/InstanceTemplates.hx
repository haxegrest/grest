...
interface InstanceTemplates {
	...
	**/
	...
	function delete(project:String, instanceTemplate:String, query:{ /**
	...
	**/
	...
	function get(project:String, instanceTemplate:String):grest.compute.v1.types.InstanceTemplate;
	/**
	...
	**/
	@:optional
	var requestId : String; }, body:grest.compute.v1.types.InstanceTemplate):grest.compute.v1.types.Operation;
	/**
	...
	**/
	@:optional
	var returnPartialSuccess : Bool; }):grest.compute.v1.types.InstanceTemplateList;
	/**
