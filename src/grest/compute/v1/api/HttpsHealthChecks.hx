...
interface HttpsHealthChecks {
	/**
		Deletes the specified HttpsHealthCheck resource.
	**/
	@:delete("/compute/v1/projects/$project/global/httpsHealthChecks/$httpsHealthCheck")
	function delete(project:String, httpsHealthCheck:String, query:{ /**
	...
	**/
	...
	function get(project:String, httpsHealthCheck:String):grest.compute.v1.types.HttpsHealthCheck;
	/**
	...
	**/
	@:optional
	var requestId : String; }, body:grest.compute.v1.types.HttpsHealthCheck):grest.compute.v1.types.Operation;
	/**
	...
	**/
	@:optional
	var returnPartialSuccess : Bool; }):grest.compute.v1.types.HttpsHealthCheckList;
	/**
		Updates a HttpsHealthCheck resource in the specified project using the data included in the request. This method supports PATCH semantics and uses the JSON merge patch format and processing rules.
	**/
	@:patch("/compute/v1/projects/$project/global/httpsHealthChecks/$httpsHealthCheck")
	function patch(project:String, httpsHealthCheck:String, query:{ /**
		An optional request ID to identify requests. Specify a unique request ID so that if you must retry your request, the server will know to ignore the request if it has already been completed.
	...
	**/
	...
	function update(project:String, httpsHealthCheck:String, query:{ /**
		An optional request ID to identify requests. Specify a unique request ID so that if you must retry your request, the server will know to ignore the request if it has already been completed.
