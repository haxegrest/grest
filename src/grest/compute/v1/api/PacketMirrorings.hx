...
interface PacketMirrorings {
	...
	**/
	@:optional
	var returnPartialSuccess : Bool; }):grest.compute.v1.types.PacketMirroringAggregatedList;
	/**
		Deletes the specified PacketMirroring resource.
	**/
	@:delete("/compute/v1/projects/$project/regions/$region/packetMirrorings/$packetMirroring")
	function delete(project:String, region:String, packetMirroring:String, query:{ /**
	...
	**/
	...
	function get(project:String, region:String, packetMirroring:String):grest.compute.v1.types.PacketMirroring;
	/**
	...
	**/
	@:optional
	var requestId : String; }, body:grest.compute.v1.types.PacketMirroring):grest.compute.v1.types.Operation;
	/**
	...
	**/
	@:optional
	var returnPartialSuccess : Bool; }):grest.compute.v1.types.PacketMirroringList;
	/**
		Patches the specified PacketMirroring resource with the data included in the request. This method supports PATCH semantics and uses JSON merge patch format and processing rules.
	**/
	@:patch("/compute/v1/projects/$project/regions/$region/packetMirrorings/$packetMirroring")
	function patch(project:String, region:String, packetMirroring:String, query:{ /**
		An optional request ID to identify requests. Specify a unique request ID so that if you must retry your request, the server will know to ignore the request if it has already been completed. For example, consider a situation where you make an initial request and the request times out. If you make the request again with the same request ID, the server can check if original operation with the same request ID was received, and if so, will ignore the second request. This prevents clients from accidentally creating duplicate commitments. The request ID must be a valid UUID with the exception that zero UUID is not supported ( 00000000-0000-0000-0000-000000000000).
	**/
	@:optional
	var requestId : String; }, body:grest.compute.v1.types.PacketMirroring):grest.compute.v1.types.Operation;
