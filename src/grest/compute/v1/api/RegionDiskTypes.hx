...
interface RegionDiskTypes {
	/**
		Returns the specified regional disk type. Gets a list of available disk types by making a list() request.
	**/
	@:get("/compute/v1/projects/$project/regions/$region/diskTypes/$diskType")
	function get(project:String, region:String, diskType:String):grest.compute.v1.types.DiskType;
	/**
	...
	**/
	@:optional
	var returnPartialSuccess : Bool; }):grest.compute.v1.types.RegionDiskTypeList;
}