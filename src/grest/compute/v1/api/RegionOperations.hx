...
interface RegionOperations {
	/**
		Deletes the specified region-specific Operations resource.
	**/
	@:delete("/compute/v1/projects/$project/regions/$region/operations/$operation")
	function delete(project:String, region:String, operation:String):tink.core.Noise;
	/**
		Retrieves the specified region-specific Operations resource.
	**/
	@:get("/compute/v1/projects/$project/regions/$region/operations/$operation")
	function get(project:String, region:String, operation:String):grest.compute.v1.types.Operation;
	/**
	...
	**/
	...
	function wait(project:String, region:String, operation:String):grest.compute.v1.types.Operation;
}