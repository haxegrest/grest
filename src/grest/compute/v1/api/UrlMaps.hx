...
interface UrlMaps {
	...
	**/
	@:optional
	var returnPartialSuccess : Bool; }):grest.compute.v1.types.UrlMapsAggregatedList;
	/**
		Deletes the specified UrlMap resource.
	**/
	@:delete("/compute/v1/projects/$project/global/urlMaps/$urlMap")
	function delete(project:String, urlMap:String, query:{ /**
	...
	**/
	...
	function get(project:String, urlMap:String):grest.compute.v1.types.UrlMap;
	/**
	...
	**/
	...
	function invalidateCache(project:String, urlMap:String, query:{ /**
		An optional request ID to identify requests. Specify a unique request ID so that if you must retry your request, the server will know to ignore the request if it has already been completed.
	...
	**/
	@:optional
	var requestId : String; }, body:grest.compute.v1.types.CacheInvalidationRule):grest.compute.v1.types.Operation;
	/**
	...
	**/
	...
	function patch(project:String, urlMap:String, query:{ /**
		An optional request ID to identify requests. Specify a unique request ID so that if you must retry your request, the server will know to ignore the request if it has already been completed.
	...
	**/
	...
	function update(project:String, urlMap:String, query:{ /**
		An optional request ID to identify requests. Specify a unique request ID so that if you must retry your request, the server will know to ignore the request if it has already been completed.
	...
	**/
	...
	function validate(project:String, urlMap:String, body:grest.compute.v1.types.UrlMapsValidateRequest):grest.compute.v1.types.UrlMapsValidateResponse;
}