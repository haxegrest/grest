...
interface RegionCommitments {
	...
	**/
	@:optional
	var returnPartialSuccess : Bool; }):grest.compute.v1.types.CommitmentAggregatedList;
	/**
		Returns the specified commitment resource. Gets a list of available commitments by making a list() request.
	**/
	@:get("/compute/v1/projects/$project/regions/$region/commitments/$commitment")
	function get(project:String, region:String, commitment:String):grest.compute.v1.types.Commitment;
	/**
	...
	**/
	@:optional
	var requestId : String; }, body:grest.compute.v1.types.Commitment):grest.compute.v1.types.Operation;
	/**
	...
	**/
	@:optional
	var returnPartialSuccess : Bool; }):grest.compute.v1.types.CommitmentList;
}