...
interface Addresses {
	...
	**/
	@:optional
	var returnPartialSuccess : Bool; }):grest.compute.v1.types.AddressAggregatedList;
	/**
		Deletes the specified address resource.
	**/
	@:delete("/compute/v1/projects/$project/regions/$region/addresses/$address")
	function delete(project:String, region:String, address:String, query:{ /**
	...
	**/
	...
	function get(project:String, region:String, address:String):grest.compute.v1.types.Address;
	/**
	...
	**/
	@:optional
	var requestId : String; }, body:grest.compute.v1.types.Address):grest.compute.v1.types.Operation;
	/**
	...
	**/
	@:optional
	var returnPartialSuccess : Bool; }):grest.compute.v1.types.AddressList;
}