...
interface GlobalPublicDelegatedPrefixes {
	/**
		Deletes the specified global PublicDelegatedPrefix.
	**/
	@:delete("/compute/v1/projects/$project/global/publicDelegatedPrefixes/$publicDelegatedPrefix")
	function delete(project:String, publicDelegatedPrefix:String, query:{ /**
	...
	**/
	...
	function get(project:String, publicDelegatedPrefix:String):grest.compute.v1.types.PublicDelegatedPrefix;
	/**
	...
	**/
	...
	function patch(project:String, publicDelegatedPrefix:String, query:{ /**
		An optional request ID to identify requests. Specify a unique request ID so that if you must retry your request, the server will know to ignore the request if it has already been completed.
