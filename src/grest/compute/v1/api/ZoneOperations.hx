...
interface ZoneOperations {
	...
	**/
	...
	function delete(project:String, zone:String, operation:String):tink.core.Noise;
	/**
		Retrieves the specified zone-specific Operations resource.
	**/
	@:get("/compute/v1/projects/$project/zones/$zone/operations/$operation")
	function get(project:String, zone:String, operation:String):grest.compute.v1.types.Operation;
	/**
	...
	**/
	...
	function wait(project:String, zone:String, operation:String):grest.compute.v1.types.Operation;
}