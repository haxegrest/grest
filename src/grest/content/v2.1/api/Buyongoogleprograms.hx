...
interface Buyongoogleprograms {
	...
	**/
	...
	function activate(merchantId:String, regionCode:String, body:grest.content.v2.1.types.ActivateBuyOnGoogleProgramRequest):tink.core.Noise;
	/**
	...
	**/
	...
	function onboard(merchantId:String, regionCode:String, body:grest.content.v2.1.types.OnboardBuyOnGoogleProgramRequest):tink.core.Noise;
	/**
	...
	**/
	...
	function pause(merchantId:String, regionCode:String, body:grest.content.v2.1.types.PauseBuyOnGoogleProgramRequest):tink.core.Noise;
	/**
	...
	**/
	...
	function requestreview(merchantId:String, regionCode:String, body:grest.content.v2.1.types.RequestReviewBuyOnGoogleProgramRequest):tink.core.Noise;
}