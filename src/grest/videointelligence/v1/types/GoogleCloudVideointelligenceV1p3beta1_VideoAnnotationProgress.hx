...
typedef GoogleCloudVideointelligenceV1p3beta1_VideoAnnotationProgress = {
	/**
		Specifies which feature is being tracked if the request contains more than one feature.
	**/
	@:optional
	var feature : grest.videointelligence.v1.types.GoogleCloudVideointelligenceV1p3beta1_VideoAnnotationProgress_feature;
	/**
