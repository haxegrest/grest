package grest.orgpolicy.v2.api.projects;
interface Policies {
	/**
	...
	**/
	@:get("/v2/$name")
	function getEffectivePolicy(name:grest.orgpolicy.v2.types.Api_orgpolicy_projects_policies_getEffectivePolicy_name_Command):grest.orgpolicy.v2.types.GoogleCloudOrgpolicyV2Policy;
	/**
