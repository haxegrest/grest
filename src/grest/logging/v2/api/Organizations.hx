...
interface Organizations {
	@:sub("/")
	var exclusions : grest.logging.v2.api.organizations.Exclusions;
	/**
	...
	**/
	...
	@:sub("/")
	var locations : grest.logging.v2.api.organizations.Locations;
	@:sub("/")
	var logs : grest.logging.v2.api.organizations.Logs;
	@:sub("/")
	var sinks : grest.logging.v2.api.organizations.Sinks;
	/**
