package grest.logging.v2.api.organizations.locations;
interface Buckets {
	/**
	...
	**/
	@:post("/v2/$name")
	function undelete(name:grest.logging.v2.types.Api_logging_organizations_locations_buckets_undelete_name_Command, body:grest.logging.v2.types.UndeleteBucketRequest):grest.logging.v2.types.Empty;
	@:sub("/")
	var views : grest.logging.v2.api.organizations.locations.buckets.Views;
}