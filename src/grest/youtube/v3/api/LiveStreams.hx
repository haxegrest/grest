...
interface LiveStreams {
	...
	**/
	@:optional
	var onBehalfOfContentOwnerChannel : String; }):tink.core.Noise;
	/**
	...
	**/
	var part : String; }, body:grest.youtube.v3.types.LiveStream):grest.youtube.v3.types.LiveStream;
	/**
	...
	**/
	var part : String; }):grest.youtube.v3.types.LiveStreamListResponse;
	/**
